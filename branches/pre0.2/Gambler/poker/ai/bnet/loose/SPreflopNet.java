...
public class SPreflopNet extends PokerNet
{
	...
	public void buildQueries() throws BayesError
	{
		...
		grpQuery.setObserved("hole", "pos", "action", "in_pot", "bias", "style");
	 ...
	 */
	public void compute(String name, Map<String,String> omap, Map<String,Distribution> pmap, Map<String, Distribution> qmap)
	{
		Query query;
		if (name.equals("fwd"))
			query = fwdQuery;
	...
	{
		BayesNode[] nodes = new BayesNode[] {hole, bias, style, pos, group, action, strat, in_pot};
