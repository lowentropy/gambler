...
class optionsFrame extends Frame
{
	...
	private static final long	serialVersionUID	= 855975001374811178L;

	static String[]		names			=
											{ "Encoding", "Use CopyRect",
			"Mouse buttons 2 and 3", "Raw pixel drawing", "CopyRect",
			"Share desktop",				};
	...
	final int			encodingIndex	= 0, useCopyRectIndex = 1,
			mouseButtonIndex = 2, rawPixelDrawingIndex = 3,
	...
	void setOtherOptions()
	{
		...
		drawEachPixelForRawRects = choices[rawPixelDrawingIndex]
				.getSelectedItem().equals("Reliable");

		copyRectFast = (choices[copyRectFastIndex].getSelectedItem()
				.equals("Fast"));
