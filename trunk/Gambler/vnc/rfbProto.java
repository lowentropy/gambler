...
class rfbProto
{
	...
	static final int	ConnFailed					= 0, NoAuth = 1,
			VncAuth = 2;

	static final int	VncAuthOK					= 0, VncAuthFailed = 1,
			VncAuthTooMany = 2;

	static final int	FramebufferUpdate			= 0,
			SetColourMapEntries = 1, Bell = 2, ServerCutText = 3;

	static final int	SetPixelFormat				= 0,
			FixColourMapEntries = 1, SetEncodings = 2,
			FramebufferUpdateRequest = 3, KeyEvent = 4, PointerEvent = 5,
			ClientCutText = 6;

	static final int	EncodingRaw					= 0, EncodingCopyRect = 1,
	...
	void readVersionMsg() throws IOException
	{
		...
		System.out.println("read msg: version");
	}
	...
	void writeVersionMsg() throws IOException
	{
		...
		os.write(b);
		System.out.println("wrote msg: version");
	}
	...
	int readAuthScheme() throws IOException
	{
		...
		System.out.println("read msg: auth scheme");
		switch (authScheme) {
	...
	{
		System.out.println("wrote msg: client init");
	...
	{
		System.out.println("read msg: server init");
	...
	{
		System.out.println("read msg: type");
		int t = is.read();
		return t;
	}
	...
	{
		System.out.println("read msg: fb upd");
		is.readByte();
	...
	{
		System.out.println("read msg: rect hdr");
